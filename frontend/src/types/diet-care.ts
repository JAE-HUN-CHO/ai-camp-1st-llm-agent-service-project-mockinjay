...
/** Compatibility stage identifiers used by the original diet-care contract. */
export const CKDStage = {
  Stage1: 'stage1',
  Stage2: 'stage2',
  Stage3a: 'stage3a',
  Stage3b: 'stage3b',
...
export type CKDStage = typeof CKDStage[keyof typeof CKDStage];
...
/** Legacy discriminated nutrition result retained for API/test compatibility. */
