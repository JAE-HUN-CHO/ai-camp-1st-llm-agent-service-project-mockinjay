 ...
 * Add Button
 */
type AddButtonProps = Omit<BaseButtonWithIconProps, 'icon' | 'iconComponent'>
 ...
 * Edit Button
 */
type EditButtonProps = Omit<BaseButtonWithIconProps, 'icon' | 'iconComponent'>
 ...
 * Share Button
 */
type ShareButtonProps = Omit<BaseButtonWithIconProps, 'icon' | 'iconComponent'>
