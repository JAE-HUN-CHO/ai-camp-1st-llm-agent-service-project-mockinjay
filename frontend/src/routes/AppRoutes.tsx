...
// Main feature pages
const ChatPageEnhanced = lazy(() => import('../features/chat/ChatPage'));
const DietCarePageEnhanced = lazy(() => import('../features/diet/DietCarePage'));
const CommunityPageEnhanced = lazy(() => import('../features/community/CommunityPage'));
const TrendsPageEnhanced = lazy(() => import('../features/research/TrendsPage'));

// Quiz pages
const QuizListPage = lazy(() => import('../features/quiz/QuizListPage'));
const QuizPage = lazy(() => import('../features/quiz/QuizPage'));
const QuizCompletionPage = lazy(() => import('../features/quiz/QuizCompletionPage'));

// Dashboard - Removed, redirected to Trends page

// Detail/Utility pages
const MyPageEnhanced = lazy(() => import('../features/account/MyPage'));
const NewsDetailPage = lazy(() => import('../features/research/NewsDetailPage'));
const BookmarkPage = lazy(() => import('../features/account/BookmarkPage'));
    ...
    <Suspense fallback={<PageLoader />}>
      <Routes>
        <Route element={<AppLayout />}>
          ...
          {/* Legacy URL alias retained during frontend consolidation. */}
          <Route path="/community/detail/:id" element={<CommunityPageEnhanced />} />
