...
def get_health_records_collection() -> AsyncIOMotorCollection:
    """활성 Health Records v1 컬렉션 반환."""
    return Database.get_collection("health_records")


def get_health_profiles_collection() -> AsyncIOMotorCollection:
    """활성 MyPage Health Profile v1 컬렉션 반환."""
    return Database.get_collection("health_profiles")
