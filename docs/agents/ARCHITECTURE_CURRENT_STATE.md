...
| Phase 3B Health Profile 고정 gate | Git `8d86aee982ae5eb61061f2b0f245d98434dca410`, run `20260817T024513Z` | active MyPage REST v1/`health_profiles` schema 보존, legacy/hex 실제 HTTP, owner isolation, invalid selector fail-closed evidence; fingerprint는 manifest가 authoritative |
...
`logs/verification/8d86aee982ae5eb61061f2b0f245d98434dca410/20260817T024513Z/manifest.json`에 있다.
...
`20260817T024513Z/manifest.json`을 기준으로 한다. Health Profile에는 provider port가 없고 검증
